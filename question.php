...
/**
 * kis_mws question definition class.
 *
 * @package    qtype
 * @subpackage kis_mws
...
/**
 * Represents an kis_mws question.
 *
 * @copyright  2017 Igor Karpukhin
 * @copyright  2009 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_kis_mws_question extends question_with_responses {
     ...
     * @return qtype_kis_mws_format_renderer_base the response-format-specific renderer.
     */
    public function get_format_renderer(moodle_page $page) {
        return $page->get_renderer('qtype_kis_mws', 'format_' . $this->responseformat);
    }
    ...
    public function get_expected_data() {
        ...
        $expecteddata['ssanswer'] = PARAM_RAW_TRIMMED;
        return $expecteddata;
    }
    ...
    public function check_file_access($qa, $options, $component, $filearea, $args, $forcedownload) {
        ...
        } else if ($component == 'qtype_kis_mws' && $filearea == 'graderinfo') {
