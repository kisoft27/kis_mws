...
/**
 * Strings for component 'qtype_kis_mws', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    qtype
 * @subpackage essay
...
$string['pluginname'] = 'Spreadsheet (kis_mws)';
...
$string['pluginname_link'] = 'question/type/kis_mws';
$string['pluginnameadding'] = 'Adding an Spreadsheet (kis_mws) question';
$string['pluginnameediting'] = 'Editing an Spreadsheet (kis_mws) question';
